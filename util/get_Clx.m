function [cCl,wCl,Cl2d,l,binl,dCl]=get_Clx(map1,map2,mask,Mkk,beam,weight,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  p.addRequired('map1',@isnumeric);
  p.addRequired('map2',@isnumeric);
  ...
  p.parse(map1,map2,mask,Mkk,beam,weight,varargin{:});
  ...
  clear p varargin;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
map1(find(map1~=map1))=0;
map1(find(map1==inf))=0;
map1(find(map1==-inf))=0;
map2(find(map2~=map2))=0;
map2(find(map2==inf))=0;
map2(find(map2==-inf))=0;


map1=map1.*mask;
map1=map1-mean(map1(find(map1)));map1=map1.*mask;
map2=map2.*mask;
map2=map2-mean(map2(find(map2)));map2=map2.*mask;

[~,l,~,~,binl,~,Cl2d] = get_angular_spec(map1,map2,beam);
