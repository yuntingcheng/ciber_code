function ihlmap=make_ihl_pl(flight,inst,ifield,m_min,m_max,A,alpha_prof)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Produce a power-law ihl around sources between m_min,m_max.
%
%
%Input:
%(Reqiured)
...
for i=1:numel(subm_arr)
    ...
    map=ihlamp*subI_arr(i)*A.*radmap.^alpha_prof;
end
