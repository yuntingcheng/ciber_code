function plot_ihl_stack_hist(flight,inst)
...
for im=1:3
    ...
    h=legend({'CIBER stars','CIBER galaxies','bk'},...
        'Location','northwest');
    set(h,'fontsize',10)
    legend boxoff
    errorbar(r_arr.*0.98,profscb,profscb_err,'r.','markersize',10);
...
errorbar(r_arr,ihltot,ihltot_err,'k.','markersize',10);
loglog(r_arr,-ihltot,'ko','markersize',5);hold on
errorbar(r_arr,-ihltot,ihltot_err,'ko','markersize',5);
