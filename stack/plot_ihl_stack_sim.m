function plot_ihl_stack_sim(flight,inst,setsim)
...
load(sprintf('%s/%s_ihlprofdatsim%d',loaddir,dt.name,setsim),'ihlprofdat');
...
savename=strcat(pltsavedir,dt.name,'_stackprof',num2str(setsim));
...
suptitle(dt.name);
savename=strcat(pltsavedir,dt.name,'_excessprof',num2str(setsim));
print(savename,'-dpng');%close
...
savename=strcat(pltsavedir,'excess_all',num2str(setsim));
print(savename,'-dpng');%close
%%
figure
...
savename=strcat(pltsavedir,'excess_avg',num2str(setsim));
print(savename,'-dpng');%close
