function [srcdat]=hsc_src_select(flight,inst,ifield,hsc_idx,m_min,m_max,...
    mask_inst,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
p = inputParser;
  ...
  p.parse(flight,inst,ifield,hsc_idx,m_min,m_max,mask_inst,varargin{:});
...
catdir=strcat(mypaths.ciberdir, 'doc/20170617_Stacking/maps/catcoord/HSC/');
